...
whose \[i\]-th column \[\breve {\mathbf{x}}_i=\mathbf{x}_i/\|\mathbf{x}_i\|\].
...
Since standardization is of no help, if we have a degenerate system,
as detected by a large condition number of \[\breve X\],
...
collect more data if you don't think its degen
